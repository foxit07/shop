...
@section('content')
    ...
    <form action="{{ route('products.update', $product->id) }}" method="POST" id="productsForm">
        {{ csrf_field() }}
        {{ method_field('PATCH') }}
            ...
            <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
                <div class="mt-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="product" placeholder="Product" name="name" value="{{ $product->name }}">
                    </div>
                    <div class="form-group">
            ...
            <div class="tab-pane fade" id="data" role="tabpanel" aria-labelledby="data-tab">
                <div class="mt-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="quantity" placeholder="Quantity" name="quantity" value="{{ $product->quantity }}">
                    </div>
                    <div class="form-group">
                            ...
                            <select class="form-control" id="{{ $group->name }}" name="attributes[]">
                                @foreach($group->attributes as $attribute)
                                    ...
                                    @foreach($product->attributes as $productAttribute)
                                        {{ $attribute->id == $productAttribute->id ? 'selected' : '' }}
                                            @endforeach
