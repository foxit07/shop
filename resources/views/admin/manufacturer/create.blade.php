...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <h4 class="c-grey-900 mT-10 mB-15">Manufacturers</h4>
        </div>
    ...
    <div class="tab-content" id="manufacturer">
        <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
            <div class="mt-3">
                <form action="{{ route('manufacturers.store') }}" method="POST" id="manufacturerForm">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <label for="manufacturer">Manufacturer</label>
                        <input type="text" class="form-control" id="manufacturer" placeholder="Manufacturer" name="name">
                    </div>
                </form>
            </div>
        </div>
